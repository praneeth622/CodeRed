          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link href="/Dashboard" className="inline-flex items-center px-1 pt-1 text-sm font-medium transition-colors duration-200 border-b-2 border-transparent text-gray-500 hover:text-gray-700">
                  Dashboard
                </Link>
                <DropdownMenu>
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden">
            <div className="pt-2 pb-3 space-y-1">
              ...
              <Link href="/Dashboard" className="block px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-100">
                Dashboard
              </Link>
